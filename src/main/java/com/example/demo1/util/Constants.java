...
public class Constants {
     ...
     * 根据id查找专题图id列表
     */
    public static final String SQL_FIND_CUSTOM_THEMATIC_IDS_BY_ID = "select stc.id from sesgis_vv_theme_sets svts left join sesgis_vv_theme_rels svtr on svtr.theme_set_id = svts.id left join sesgis_theme_configs stc on stc.id = svtr.theme_id where svts.valid = 1 and svtr.valid = 1 and stc.valid = 1 and svts.id = 1000";
